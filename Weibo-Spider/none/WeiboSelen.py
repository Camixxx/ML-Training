...
def LoginWeibo(username, password):
    try:
        ...
        driver.current_url
        print
        driver.get_cookies()  # 获得cookie信息 dict存储
        print
        u'输出Cookie键值对信息:'
...
def VisitPersonPage(user_id):
    try:
        ...
        print
        str_wb.text  # 微博[294] 关注[351] 粉丝[294] 分组[1] @他的
        for value in guid:
            num_wb = int(value)
            break
        ...
        while num <= 5:
            ...
            for value in info:
                ...
                if u'设置:皮肤.图片' not in info:
                    ...
                    u'微博内容:'
                    print
                    info[:info.rindex(u" 赞")]  # 后去最后一个赞位置
...
if __name__ == '__main__':
    ...
    # 定义变量
    username = 'hatikoy@163.com'  # 输入你的用户名
    password = 'maomao0000'  # 输入你的密码
    user_id = 'pinyin_沉迷律律'  # 用户id url+id访问个人
